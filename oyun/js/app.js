...
const gamesList = [
    ...
    {
        id: "game_spear",
        title: "🗡️ شەرقىي تۈركىستان نەيزىۋاز",
        description: "ئۇيغۇر باتۇرى ئەزىمەن بولۇپ خەن سۇلالىسى ئەسكىرىگە قارشى نەيزە ئاتىشمىسىدا غەلىبە قازاناي! نەيزە ئاتىپ دۈشمەننى مەغلۇپ قىل!",
        icon: "fa-khanda",
        url: "games/game-spear.html",
        tags: ["ھەرىكەتلىك", "تارىخ", "نەيزە", "شەرقىي تۈركىستان"],
        category: "action",
        isNew: true
    },
