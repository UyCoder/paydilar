...
const gamesList = [
    // ==================== يېڭى 5 ئويۇن (NEW!) ====================
    {
        id: "game_racer",
        title: "🏎️ تېز يۈگۈر",
        description: "ماشىنىڭىزنى سولغا ياكى ئوڭغا يۆتكەپ توساقلاردىن ساقلىنىڭ! يۇلتۇزلارنى يىغىپ نومۇر يىغىڭ، سۈرئەت ئاشقانسېرى قىزىقارلىق بولىدۇ!",
        icon: "fa-car",
        url: "games/game-racer.html",
        tags: ["ھەرىكەتلىك", "تېزلىك", "ماشىنا"],
        category: "action",
        isNew: true
    },
    {
        id: "game_whack",
        title: "🔨 مول ئۇر",
        description: "يەردىن چىققان قاراقچىلارنى چېكىپ ئۇرۇڭ! ئالتۇن چىققاندا كۆپ نومۇر، بومبىدىن ساقلىنىڭ! كومبو يىغىپ رېكورد بۇزۇڭ!",
        icon: "fa-gavel",
        url: "games/game-whack.html",
        tags: ["ھەرىكەتلىك", "چاققانلىق", "كومبو"],
        category: "action",
        isNew: true
    },
    {
        id: "game_fruit",
        title: "🍉 مېۋە كەس",
        description: "ئاسمانغا ئۆرلىگەن مېۋىلەرنى بارماق بىلەن سىزىپ كېسىڭ! بومبىدىن ساقلىنىڭ، قاتار كەسكەنسېرى كومبو كۆپىيىدۇ!",
        icon: "fa-apple-alt",
        url: "games/game-fruit.html",
        tags: ["ھەرىكەتلىك", "چاققانلىق", "مېۋە"],
        category: "action",
        isNew: true
    },
    {
        id: "game_catch",
        title: "⭐ يۇلتۇز تۇت",
        description: "سېۋەتنى يۆتكەپ ئاسماندىن چۈشكەن يۇلتۇزلارنى تۇتۇڭ! ئالتۇن يۇلتۇز كۆپ نومۇر، 5 باسقۇچتىن ئۆتەلەمسىز؟",
        icon: "fa-star",
        url: "games/game-catch.html",
        tags: ["ئاركادا", "يۇلتۇز", "باسقۇچ"],
        category: "arcade",
        isNew: true
    },
    {
        id: "game_dino",
        title: "🦕 دېنو سەكرەش",
        description: "دېنو بىلەن يۈگۈرۈڭ! كاكتۇستىن سەكرەڭ، تەڭگىلەرنى يىغىڭ، قۇشلاردىن ساقلىنىڭ! قانچە يىراققا بارالايسىز؟",
        icon: "fa-dragon",
        url: "games/game-dino.html",
        tags: ["ئاركادا", "سەكرەش", "دېنو"],
        category: "arcade",
        isNew: true
    },
    // ==================== Subdirectory Games ====================
